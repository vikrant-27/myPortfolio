        ...
        <div>
            {PROJECTS.map((Project,index)=>(
                <div key={index} className='mb-8 flex flex-wrap lg:justify-center '>
                    ...
                    <h6 className='mb-2  font-semibold flex'>{Project.title} <button className='text-sm bg-purple-900 text-neutral-300 rounded-lg p-1 ml-3 flex items-center hover:scale-105 cursor-pointer transition-transform duration-300 ease-out'>
